...
const RecentTransactions = ({
    ...
    const currentTransactions = transactions.slice(indexOfLastTransaction, indexOfFirstTransaction);

	return (
		<section className="recent-transactions">
			<header className="flex items-center justify-between">
				<h2 className="recet-transactions-label">Recent Transactions</h2>
				<Link
